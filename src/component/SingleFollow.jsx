...
const SingleFollow = ({img, name, title, text, poster, date, following, remove, item}) => {
  ...
  return (
    <div className='w-full'>
        ...
        <div id='top' className='w-[80%] flex justify-between pb-1'>
            ...
            <button onClick={handleClick} className='bg-gray-200 px-2 py-1 rounded-full lg:px-4 my-auto'>{follow? "Following" : "Follow"}</button>
        </div>
        <div id='mid' className='w-[100%] flex gap-2 lg:gap-5 lg:my-auto'>
            <div className='w-[80%] lg:text-[15px]'>
                <h1 className='font-bold py-1 lg:py-2'>{title}</h1>
        ...
        <div id='bottom' className='lg:w-[80%] flex md:justify-between py-3 lg:py-0'>
            <div className='flex text-gray-500 w-[80%] md:w-[50%] lg:w-[40%] md:gap-3 gap-2'>
                ...
                <div className='flex'>
                    ...
                    <sub className='text-[8px] lg:text-[12px] pt-3'>{count}</sub>
                </div>
            ...
            <div className='flex w-[30%] md:w-[35%] lg:w-[20%]'>
                ...
                <span onClick={handleMore}><img className='w-[80%] md:w-[50%] lg:w-[60%]' src={dot} alt="" /></span>
                {more && <More/>}
            </div>
        </div>
